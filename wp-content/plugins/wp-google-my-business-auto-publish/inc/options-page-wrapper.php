...
<div class="wrap">
    <div id="poststuff">
        ...
        <p><h3>A Message from the Developer</h3><p>Hi there! Thanks for using my plugin, if you like it please <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=VGVE97KF74FVN" target="_blank">donate</a> as your donation will enable me to continue developing and improving the plugin and you can also rate the plugin <a href="https://wordpress.org/support/plugin/wp-google-my-business-auto-publish/reviews/?rate=5#new-post" target="_blank"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></a>'s. If the plugin doesn't work you should take a few big breaths and write on the <a target="_blank" href="https://wordpress.org/support/plugin/wp-google-my-business-auto-publish">forum</a> for the plugin.</p>
            
            <p>Also do you need to share posts, pages and custom post types to LinkedIn? Check out our sister plugin <a href="https://wordpress.org/plugins/wp-linkedin-auto-publish/">WP LinkedIn Auto Publish</a>. It's free and works the exact same way this plugin does!</p>    
        ...
        <!--start form-->
        <form id='google_my_business_auto_publish_settings_form' action='options.php' method='post'>
            <!--start tabs-->
