    ...
    if($reviews !== 'ERROR'){
        ...
        foreach($reviews as $review){
            ...
            if($ratingTranslated[$review['starRating']] >= $minimumStars && !in_array($review['name'],$settingToArray)){
                ...
                $reviewsData[$review['name']] = array('reviewer'=>$review['reviewer']['displayName'],'date'=>$review['createTime'],'rating'=>$ratingTranslated[$review['starRating']],'comment'=>$review['comment']);
            }
        }
